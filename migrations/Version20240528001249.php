 ...
 */
final class Version20240528001249 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE application CHANGE experience experience VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE application CHANGE experience experience VARCHAR(255) DEFAULT NULL');
    }
}
